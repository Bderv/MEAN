...
const server = http.createServer(function (request, response){
    ...
    else if(request.url === '/images/evo1.jpg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/evo1.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    }
    else if(request.url === '/images/evo2.jpg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/evo2.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
